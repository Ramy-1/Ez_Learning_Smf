 ...
 */
final class Version20220408233959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD name VARCHAR(80) NOT NULL, ADD last_name VARCHAR(80) NOT NULL, ADD face_id VARCHAR(180) NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649FDC86CD0 ON user (face_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8D93D649FDC86CD0 ON user');
        $this->addSql('ALTER TABLE user DROP name, DROP last_name, DROP face_id, CHANGE email email VARCHAR(180) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, CHANGE password password VARCHAR(255) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`');
    }
}
